  ...
  return (
    ...
    >
      <div
        ...
        className="bg-white rounded-2xl w-full max-w-lg shadow-2xl border border-slate-200 overflow-hidden max-h-[90vh] flex flex-col font-tajawal"
      >
        <div className="p-5 bg-[#0B1F4D] text-white flex justify-between items-start gap-3 flex-shrink-0">
          <div className="min-w-0">
            ...
            <h3 title={title} className="font-extrabold text-sm font-cairo mt-1 truncate">{title}</h3>
          </div>
        ...
        <div className="p-5 space-y-4 overflow-y-auto">
          ...
          <div className="flex items-start gap-2">
            ...
            <div>
              <span className="text-[10px] font-extrabold text-slate-500 block">متى تستعملها</span>
          ...
          {guide.tips.length > 0 && (
            <div className="flex items-start gap-2">
              ...
              <div className="min-w-0">
                <span className="text-[10px] font-extrabold text-slate-500 block mb-1.5">نصائح عملية</span>
          ...
          {guide.related && guide.related.length > 0 && (
            <div className="pt-3 border-t border-slate-100">
              <span className="text-[10px] font-extrabold text-slate-500 flex items-center gap-1.5 mb-2">
