      ...
      <div className="flex items-start gap-2.5 p-3.5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            className="mt-2.5 px-3.5 py-2 rounded-xl bg-emerald-700 text-white text-[11px] font-extrabold flex items-center gap-1.5 cursor-pointer hover:bg-emerald-800 transition"
          >
