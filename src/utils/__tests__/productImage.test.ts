 ...
 */
describe('حارس: مسار الصورة في شاشة المنتجات', () => {
  ...
  it('🔴 الصورة تمرّ عبر الضغط — لا readAsDataURL مباشرة إلى الحقل', () => {
    expect(/compressProductImage\s*\(/.test(src), 'الصورة تُخزَّن خاماً').toBe(true);
    expect(
